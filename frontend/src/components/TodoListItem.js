        ...
        <Paper className={ classes.listItemWrapper}>
            <Grid container>
                ...
                <Grid item xs={2} className={classes.verticalCenter}>
                    <IconButton color={ props.data.is_closed ? "primary" : "default" } className={classes.chkIconButton} aria-label="directions" onClick={ changeState }>
                        <CheckBoxButtonIcon isActive={ props.data.is_closed }/>
                    </IconButton>
